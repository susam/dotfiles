...
(global-set-key (kbd "C-c j d") (cmd (find-file "~/src/susam.net/content/tree/dd/dd.txt")))
(global-set-key (kbd "C-c j n") (cmd (find-file "~/src/susam.net/content/tree/notes-2026-02.post.html")))
...
(global-set-key (kbd "C-c o p") (cmd (find-file "~/my/plan/proj.org")))
(global-set-key (kbd "C-c o s") (cmd (find-file "~/my/plan/someday.org")))
(global-set-key (kbd "C-c o w") (cmd (find-file "~/my/plan/someday.org")))
